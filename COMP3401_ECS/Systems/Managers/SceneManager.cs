...
namespace COMP3401ECS_Engine.Systems.Managers
{
    ...
    /// Date: 09/02/22
    /// </summary>
    public class SceneManager : IDraw, ISceneManager, IInitialiseParam<ISpawnEntity>, IInitialiseParam<IUpdatable>, ISpawnEntity, IUpdatable
    {
        ...
        #region IMPLEMENTATION OF IINITIALISEPARAM<ISPAWNENTITY>
        ...
        public void Initialise(ISpawnEntity pSpawnEntityObj)
        {
            ...
            if (pSpawnEntityObj != null)
            {
                ...
                try
                {
                    ...
                    (_sceneGraph as IInitialiseParam<IReadOnlyDictionary<int, IEntity>>).Initialise(_sceneEntityDict as IReadOnlyDictionary<int, IEntity>);
                }
        ...
        #region IMPLEMENTATION OF IINITIALISE<IUPDATABLE>
        ...
        public void Initialise(IUpdatable pUpdatable)
        {
            ...
            try
            {
                ...
                if (pUpdatable != null)
                {
                    ...
                    (_sceneGraph as IInitialiseParam<IUpdatable>).Initialise(pUpdatable);
                }
